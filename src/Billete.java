...
public class Billete {
  ...
  int numero;
  int tipo;  //1-a�o 2-90 minutos
  //Para que todos los tipos sean del mismo tama�o se a�ade un kk al tipo2
  ...
  int getTamanoRegistro(){
	// tama�o del array con el dni + tama�o de 8 int
  ...
  boolean leer (RandomAccessFile f) throws IOException { 
	 ...
	 //  dni=new String(dniB, "UTF-8"); //convierte el array de bytes en un string con la notaci�n UTF-8
	    dni=new String(dniB, "ISO-8859-1"); //Mejor 8859 para � y acentos.
